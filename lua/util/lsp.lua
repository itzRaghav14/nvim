...
M.on_attach = function(client, bufnr)
	...
	mapkey("<leader>gd", "Lspsaga finder", "n", opts) -- go to definition
	mapkey("<leader>gpd", "Lspsaga peek_definition", "n", opts) -- peak definition
	...
	mapkey("<leader>k", "Lspsaga hover_doc", "n", opts) -- show documentation for what is under cursor
